...
const _make_metal_pool_scope = ext._make_metal_pool

# ==============================================================================
# Metal Scope-Aware Validation: mirrors CPU test_scope_depth_validation.jl
# for MetalAdaptiveArrayPool overlap checks (_check_tp_metal_overlap).
# ==============================================================================

@testset "Metal Scope-depth-aware validation" begin

    # ------------------------------------------------------------------
    # Outer acquire, inner validate — should NOT throw
    # ------------------------------------------------------------------
    @testset "outer acquire, inner validate — should NOT throw (MtlArray)" begin
        pool = _make_metal_pool_scope(true)
    ...
    @testset "outer array inside tuple — should NOT throw" begin
        ...
        _validate_pool_return((Metal.sum(v), v), pool)
