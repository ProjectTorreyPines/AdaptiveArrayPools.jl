...
# the hook resolved to the `::Any` no-op fallback. Reuses the base `_run_auto_compact!`
...
@inline function AdaptiveArrayPools._maybe_auto_compact!(pool::MetalAdaptiveArrayPool)
